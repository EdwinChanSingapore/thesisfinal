...
\centering
\caption{Sequencing of patients with two different sequencing platforms. An F1 score indicates how well a caller can predict true positives (See Appendix 5.3 for more details). Figure from Dugas et al., 2016}
\end{figure}
