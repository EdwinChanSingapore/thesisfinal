...
\centering
\caption{Sequencing of patients with two different sequencing platofrms. F1 score of single callers, which indicates how well a caller is able to find predict true positives (See appendix 5.3 for more details). Figure from Dugas et al., 2016}
\end{figure}
